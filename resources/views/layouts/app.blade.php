...
<head>
    ...
    <title>@yield('title') - Sistem Stok Dimsum JJC</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('dashboard') }}" class="brand-link">
                <span class="brand-text font-weight-light"><i class="fas fa-boxes"></i> Stok Dimsum</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2024 <a href="#">Sistem Stok Dimsum JJC</a>.</strong>
            All rights reserved.
